    ...
    <>
      <div className="container d-flex justify-content-center align-items-center">
        <Form onSubmit={onSubmitForm}>
          ...
          <div className={`mb-3 ${errors.email? 'if-error': ''}`}>
            <Form.Group className="mt-4 form" controlId="formBasicEmail">
              <Form.Control
                type="text"
                placeholder=" "
                name="email"
          ...
          <div className={`mb-3 ${errors.password? 'if-error' : ' '}`}>
            <Form.Group className="mt-4 form" controlId="formBasicPassword">
              <Form.Control
      ...
      <br></br>
      Back to <Link to="/UserDashboard">UserDashboard</Link> Page
    </>
  );
}
